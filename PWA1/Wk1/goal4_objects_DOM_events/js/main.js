...
// this is integrating multiple data types - object with an array of objects
 ...
 var collegeNow={};
    collegeNow.schoolName='Full Sail';
    collegeNow.schoolAddress='123 University Ave';
    collegeNow.studentCount=16000
    collegeNow.students=[
        {name:'James Bond',gpa:3.2,classes:['PWA1','FLEX']},
        {name:'Jane Bond',gpa:3.5,classes:['PWA1','FLEX']},
        {name:'John Bond',gpa:3.7,classes:['PWA1','FLEX']}
    ];

    console.log(collegeNow['schoolName']);
    console.log(collegeNow.schoolName);
    var newCnt = collegeNow.studentCount;
    console.log(newCnt);
    console.log([collegeNow['schoolAddress']]);
    console.log(collegeNow.students[1].gpa);
...
----------------------------------------------------------------------------- */
    ...
    var gradeAvg=function(X){
        ...
        for(i=0;i<X.students.length;i++){
            var grades=X.students[i].gpa;
            total=total+grades;
        }
        return average = total/X.students.length;


    };
    console.log(gradeAvg(collegeNow));
...
*/
    ...
    var myNum =1;
    myString=String(myNum);//Converts myNum into a string
...
*/
    ...
    for(i=0, max=navLinks.length; i<max;i++){
        ...
        var aClass = navLinks[i].firstChild.getAttributeNode('class');
...
var nav = document.querySelectorAll('#nav li a');
    ...
    for(i=0, max=nav.length; i<max;i++){
        ...
        nav[i].onclick = function(e){
            console.log(e);
            e.preventDefault(); //prevent defaut, stops a link from ging through
        }
    }
